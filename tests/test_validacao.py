...
Cobre as regras RN01 (valida_estrutura) e RN02 (valida_campos_obrigatorios)
do PDD v0.2 (seção 12).

Executar da raiz do projeto com:  pytest -v
"""
